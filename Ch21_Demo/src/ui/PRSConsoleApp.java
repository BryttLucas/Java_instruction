	...
	private static void userSwitch(UserDB udb, int command) {
		while (command != 99) {
			...
			case 4:
				...
				int rowCount = udb.getUpdate(id, choice, change);
		...
		while (command != 99) {
			...
			case 3:
				...
				String prompt = Console
						.getString("Would you like to view a list of vendors to identify\n" + "your Vendor's ID? ");
			...
			case 4:
				...
				String choice = Console
						.getString("Would you like to change PartNumber, Name,\n" + "Price, Unit, PhotoPath? ");
				String change = Console.getString("What do you want to make " + choice + "? ");
